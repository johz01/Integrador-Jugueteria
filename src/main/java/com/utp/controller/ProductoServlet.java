...
public class ProductoServlet extends HttpServlet {
    ...
    protected void listarProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("producto", obj.selectAllid(cod));
        request.getRequestDispatcher("/pagArticulo.jsp").forward(request, response);

    }
      protected void buscarProducto(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String cod = request.getParameter("id");
        request.setAttribute("producto", obj.selectById(cod));
        request.getRequestDispatcher("/pagDetalle.jsp").forward(request, response);
