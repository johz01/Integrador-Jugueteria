...
import com.utp.model.daos.CategoriaDAO;
   ...
   CategoriaDAO obj = new CategoriaDAO();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     private void listarCategoria(HttpServletRequest request, HttpServletResponse response) 
        throws ServletException, IOException {
        request.setAttribute("Categoria", obj.selectAll());
        request.getRequestDispatcher("/pagCategoria.jsp").forward(request, response);
    }
